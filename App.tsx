...
import { PWAInstallPrompt } from './components/PWAInstallPrompt'; // Novo
...
const App = () => {
  ...
  const handleIDUploaded = (data: PersonalInfo) => {
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col font-sans">
      <PWAInstallPrompt /> {/* Popup de Instalação no topo */}
      ...
      <main className="flex-1 p-4 pb-20">
        {step === AppStep.UPLOAD_ID && <StepUploadID userId={activeUserId} onNext={handleIDUploaded} onBack={() => {}} onLoginClick={() => setIsAuthOpen(true)} />}
